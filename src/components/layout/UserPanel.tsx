      ...
      <div className="h-[60px] w-[calc(var(--sidebar-width)+55px)] bg-(--background-secondary) border border-(--border-normal) rounded-lg overflow-hidden">
        ...
        <div className="flex items-center justify-between px-2 h-full">
          ...
          <div className="flex items-center gap-2 h-full">
            <Tooltip text={theme === "dark" ? "Switch to Light Mode" : "Switch to Dark Mode"} side="top">
              <button
                onClick={toggleTheme}
                className="flex items-center justify-center w-8 h-8 rounded-md hover:bg-(--background-secondary-alt) text-(--text-secondary) hover:text-(--text-primary) transition-colors cursor-pointer"
              >
