...
export default function ServersBar() {
  ...
  return (
    <nav
      className="w-[72px] bg-[#121214] flex flex-col items-center gap-2 
                 h-full select-none overflow-visible pb-[72px] flex-none"
    >
      {/* === Discord Home Icon === */}
      ...
      {/* === Servers List === */}
      <div className="flex-1 overflow-y-auto overflow-x-visible w-full scrollbar-hide flex flex-col items-center gap-2 pt-2 border-t border-[#26272b]">
